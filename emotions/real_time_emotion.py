...
# model paths
haar_cascade_path = 'haarcascade_files/haarcascade_frontalface_default.xml'
# emotion_model_path = 'models/_mini_XCEPTION.102-0.66.hdf5'
emotion_model_path = 'models/_simpler_CNN.10-0.54.hdf5'
...
emotions_labels = ['Zlosc', 'Znieskaczenie', 'Strach', 'Radosc', 'Smutek', 'Zaskoczenie', 'Obojetnosc']
...
while True:
	...
	# detect face
	faces = face_detection.detectMultiScale(gray, scaleFactor=1.1, minNeighbors=5, minSize=(100, 100),
	...
	if len(faces) > 0:
		for (x, y, w, h) in faces:
			...
			predictions = emotion_model.predict(resized_face)
	...
	for index, emotion in enumerate(emotions_labels):
		# construct the label text
		emotion_result = "{}: {:.2f}%".format(emotion, emotion_probability * 100)
